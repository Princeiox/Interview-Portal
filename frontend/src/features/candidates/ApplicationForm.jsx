        ...
        <form onSubmit={handleSubmit} onBlur={handleBlur} className="app-form-body">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <select 
                  ...
                  style={{ color: form.gender === '' ? 'var(--color-text-muted)' : 'var(--color-text-primary)' }}
                  value={form.gender} 
              ...
              <div className="form-group">
                ...
                <select 
                  className="form-select" 
                  style={{ color: form.marital_status === '' ? 'var(--color-text-muted)' : 'var(--color-text-primary)' }}
            ...
            <div style={{ marginTop: '24px' }}>
              ...
              <div className="form-row" style={{ marginTop: '16px' }}>
                ...
                <div className="form-group">
                  ...
                  <select 
                    className="form-select" 
                    style={{ color: form.current_state === '' ? 'var(--color-text-muted)' : 'var(--color-text-primary)' }}
                    value={form.current_state} 
                    onChange={(e) => updateForm('current_state', e.target.value)} 
                    required
                  >
            ...
            <div>
              ...
              <div className="form-row" style={{ marginTop: '16px' }}>
                ...
                <div className="form-group">
                  ...
                  <select 
                    className="form-select" 
                    style={{ color: form.permanent_state === '' ? 'var(--color-text-muted)' : 'var(--color-text-primary)' }}
                    value={form.permanent_state} 
                    onChange={(e) => updateForm('permanent_state', e.target.value)} 
          ...
          <section className="app-form-section">
            ...
            <div className="form-group" style={{ maxWidth: '300px' }}>
              ...
              <select 
                className="form-select" 
                style={{ color: form.position_applied === '' ? 'var(--color-text-muted)' : 'var(--color-text-primary)' }}
                value={form.position_applied} 
                onChange={(e) => updateForm('position_applied', e.target.value)} 
                required
              >
          ...
          {/* Why Hire You */}
          <section className="app-form-section">
            <h2 className="app-form-section-title">Why Hire You</h2>
          ...
          <button
            ...
            style={{ cursor: (loading || (!isEditMode && !consent)) ? 'not-allowed' : 'pointer' }}
          >
